...
PCMPlayer.prototype.init = function(option) {
    ...
    //this.interval = setInterval(this.flush, this.option.flushingTime);//this.option.flushingTime
...
PCMPlayer.prototype.flush = function() {
    ...
    for (channel = 0; channel < this.option.channels; channel++) {
        ...
        //console.log(`channel: ${channel}, data:${audioData}`);
    }
    ...
    log(`len: ${this.samples.length} decode execute time: ${performance.now() - tt1}`);
